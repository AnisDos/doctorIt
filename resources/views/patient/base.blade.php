					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item dropdown has-arrow logged-item">
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="{{  asset ('styleDoctorIT/img/doctors/doctor-thumb-02.jpg') }}" width="31" alt="Darren Elder">
								</span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class="user-header">
									<div class="avatar avatar-sm">
										<img src="{{  asset ('styleDoctorIT/img/doctors/doctor-thumb-02.jpg') }}" alt="User Image" class="avatar-img rounded-circle">
									</div>
									<div class="user-text">
										<h6>Darren Elder</h6>
...
<div class="x_content bs-example-popovers" id="successalert" style="text-align: center;" >
  ...
  @endif
							...
							<div class="profile-sidebar">
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										...
										<div class="profile-det-info">
											<h3>{{Auth::user()->patient->nom}} {{Auth::user()->patient->prenom}} </h3>
											<div class="patient-details">
												<h5><i class="fas fa-birthday-cake"></i> {{Auth::user()->patient->date_naissance}},{{ Carbon::now()->format('Y') - Carbon::parse(Auth::user()->patient->date_naissance)->format('Y') }}  ans</h5>
												<h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> {{Auth::user()->patient->adresse}}</h5> 
											</div>
										</div>
									</div>
								</div>
								<div class="dashboard-widget">
									...
									{{-- 		<li>
											...
											<li>
												<a href="{{ url('patient/myAppointments') }}">
									...
									{{-- 		<li>
											...
											<li>
												<a href="{{ url('patient/profilSettings') }}">
													<i class="fas fa-user-cog"></i>
													<span>Profile Settings</span>
												</a>
											</li>
											<li>
												<a href="{{ url('patient/passwordreset') }}">
		...
		<!-- Circle Progress JS -->
		<script src="{{  asset ('styleDoctorIT/js/circle-progress.min.js') }}"></script>
